...
/**
  ...
  *        (USB-PD trace TX).
  *
  * The tracer drives USART1 (PA9/PA10) + GPDMA1 channel 2 directly through
  * the LL drivers (tracer_emb_conf.h).  Neither is modelled in the .ioc, so
  * CubeMX never generates these two handlers - they live in a USER CODE
  * section and therefore survive a regeneration.
  */
