...
{
  {
    .PE_SupportedSOP = USBPD_SUPPORTED_SOP_SOP|USBPD_SUPPORTED_SOP_SOP1|USBPD_SUPPORTED_SOP_SOP2|USBPD_SUPPORTED_SOP_SOP1_DEBUG    |USBPD_SUPPORTED_SOP_SOP2_DEBUG, /* Supported SOP : SOP, SOP' SOP" SOP'Debug SOP"Debug */
