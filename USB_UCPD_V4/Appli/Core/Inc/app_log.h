...
/** Watchdog TX resyncs (stuck-BUSY recoveries).  Persistent growth means
 *  the host/bus is wedging transfers (see app_log.c watchdog). */
uint32_t APP_LOG_StuckResets(void);
