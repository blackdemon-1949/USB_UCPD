...
void MX_GPDMA1_Init(void)
{
   ...
   * Channels 0/1 are the UCPD1 RX/TX DMA.  They are part of the UCPD data
  ...
  /* USBPD trace TX (tracer_emb over USART1 DMA) uses GPDMA1 Channel 2.
     The .ioc does not model this channel, so it lives in this USER CODE
     section on purpose: regeneration keeps it. */
