...
/**
  ...
  *         1 = NOR init, 2 = memory-map, 3 = no valid Appli vector, 4 = jump returned, 5 = generic
  */
static void Boot_Fail(uint8_t code)
{
  __disable_irq();
...
static void MPU_Config(void)
{
  ...
  */
  ...
  /** Region 2: 8 MB XSPI1 NOR (PY25Q64HA) — required before the jump
  */
